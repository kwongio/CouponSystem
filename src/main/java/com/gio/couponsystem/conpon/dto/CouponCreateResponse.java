...
public record CouponCreateResponse(
        ...
        @Schema(description = "쿠폰 제목", example = "10% 할인 쿠폰") String title,
        @Schema(description = "쿠폰 수량", example = "100") long quantity,
        @Schema(description = "쿠폰 시작 날짜", example = "2023-12-01T00:00:00") LocalDateTime startDate,
        @Schema(description = "쿠폰 종료 날짜", example = "2023-12-31T23:59:59") LocalDateTime endDate
) {
